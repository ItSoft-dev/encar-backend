...
def send_car_to_channel(sender, instance, created, **kwargs):
    ...
    caption = (
        ...
        f"<a href='https://gm-car.vercel.app/cars/{instance.id}'>ссылка</a>\n\n"
        f"🌐 На сайте <a href='https://gm-car.vercel.app/search-auto?brand={instance.brand.id}'>ссылка</a> "
        ...
        f"<a href='https://t.me/user_py'>@user_py</a>"
    )
