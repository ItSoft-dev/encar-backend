...
from core.apps.common.views.main import AboutProjectListApiView, ContactListApiView, PartnerListApiView, FeedBackListApiView, DisclaimerListApiView, ReturnPolicyListApiView, PrivacyPolicyListApiView, OfferAgreementListApiView, OrderCarImportListApiView, SecureTransactionListApiView
